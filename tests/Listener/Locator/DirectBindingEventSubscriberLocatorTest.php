...
use GpsLab\Domain\Event\Listener\Locator\DirectBindingEventSubscriberLocator;
...
class DirectBindingEventSubscriberLocatorTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var DirectBindingEventSubscriberLocator
     */
    private $locator;

    protected function setUp()
    {
        $this->locator = new DirectBindingEventSubscriberLocator();
    }
