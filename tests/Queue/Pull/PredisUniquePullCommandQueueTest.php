...
use GpsLab\Domain\Event\Queue\Pull\PredisUniquePullEventQueue;
...
class PredisUniquePullEventQueueTest extends \PHPUnit_Framework_TestCase
{
    /**
     ...
     * @param string $format
     *
     * @return PredisUniquePullEventQueue
     */
    private function queue($format)
    {
        return new PredisUniquePullEventQueue(
            $this->client,
            $this->serializer,
            $this->logger,
            $this->queue_name,
